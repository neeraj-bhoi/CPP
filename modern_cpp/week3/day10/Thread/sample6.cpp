...
private:
    int _amount{0};
    std::mutex mt;
    static BankingOperations* _solo_hero_obj;
...
BankingOperations* BankingOperations::_solo_hero_obj {nullptr};


int main() {
    BankingOperations* obj = BankingOperations::getFirstInstance(1000);
