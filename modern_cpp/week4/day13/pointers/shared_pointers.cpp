...
int main() {
    ...
    std::shared_ptr<Employee> ptr = std::make_shared<Employee>("harshit", 670000.0f, "trainer", 10);
...
/*
    shared pointer
    ptr-----------> [ 0x111H ]  | reference count : 3 (number of shared counts..)
                                                    deletes if last copy goes out of scope
*/